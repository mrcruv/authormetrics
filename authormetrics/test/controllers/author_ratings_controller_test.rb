...
class AuthorRatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create author_rating" do
    assert_difference("AuthorRating.count") do
      post author_ratings_url, params: { author_rating: { author_id: @author_rating.author_id, rating: @author_rating.rating, rating_timestamp: @author_rating.rating_timestamp, user_id: @author_rating.user_id } }
    end
  ...
  test "should update author_rating" do
    patch author_rating_url(@author_rating), params: { author_rating: { author_id: @author_rating.author_id, rating: @author_rating.rating, rating_timestamp: @author_rating.rating_timestamp, user_id: @author_rating.user_id } }
