...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference("Administrator.count") do
      post administrators_url, params: { administrator: { admin_id: @administrator.admin_id, password: @administrator.password, username: @administrator.username } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { admin_id: @administrator.admin_id, password: @administrator.password, username: @administrator.username } }
