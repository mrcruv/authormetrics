...
ActiveRecord::Schema[7.0].define(version: 0) do
  ...
  create_table "authors", primary_key: "_id", id: { type: :string, limit: 25 }, force: :cascade do |t|
    t.string "nome_cognome", limit: 50, null: false
    t.string "interest", limit: 25, array: true
    t.text "affiliazioni"
  end

  create_table "autori_preferiti", primary_key: ["utenti_id", "authors_id"], force: :cascade do |t|
    t.string "authors_id", limit: 25, null: false
    t.serial "utenti_id", null: false
  end
  ...
  create_table "rating_autori", primary_key: ["utenti_id", "authors_id"], force: :cascade do |t|
    t.string "authors_id", limit: 25, null: false
    t.serial "utenti_id", null: false
    t.integer "rating", null: false
    t.date "data_valutazione", null: false
  ...
  create_table "recensioni_autori", primary_key: ["authors_id", "utenti_id"], force: :cascade do |t|
    t.string "authors_id", limit: 25, null: false
    t.serial "utenti_id", null: false
  ...
  create_table "scritti", primary_key: ["authors_id", "articoli_id"], force: :cascade do |t|
    t.string "authors_id", limit: 25, null: false
    t.string "articoli_id", limit: 25, null: false
  end
  ...
  add_foreign_key "autori_preferiti", "authors", column: "authors_id", primary_key: "_id", name: "autori_preferiti_authors_id_fkey"
  ...
  add_foreign_key "rating_autori", "authors", column: "authors_id", primary_key: "_id", name: "rating_autori_authors_id_fkey"
  add_foreign_key "rating_autori", "utenti", name: "rating_autori_utenti_id_fkey"
  add_foreign_key "recensioni_autori", "authors", column: "authors_id", primary_key: "_id", name: "recensioni_autori_authors_id_fkey"
  ...
  add_foreign_key "scritti", "authors", column: "authors_id", primary_key: "_id", name: "scritti_authors_id_fkey"
end
