class RatingAutoresController < ApplicationController
  before_action :set_rating_autore, only: %i[ show edit update destroy ]

  # GET /rating_autores or /rating_autores.json
  def index
    @rating_autores = RatingAutore.all
  end

  # GET /rating_autores/1 or /rating_autores/1.json
  def show
  end

  # GET /rating_autores/new
  def new
    @rating_autore = RatingAutore.new
  end

  # GET /rating_autores/1/edit
  def edit
  end

  # POST /rating_autores or /rating_autores.json
  def create
  ...
  # PATCH/PUT /rating_autores/1 or /rating_autores/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /rating_autores/1 or /rating_autores/1.json
  def destroy
    @rating_autore.destroy

    respond_to do |format|
      format.html { redirect_to rating_autores_url, notice: "Rating autore was successfully destroyed." }
