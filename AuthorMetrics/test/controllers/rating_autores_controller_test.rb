...
class RatingAutoriControllerTest < ActionDispatch::IntegrationTest
  setup do
    @rating_autore = rating_autori(:one)
  end

  test "should get index" do
    get rating_autori_url
  ...
  test "should create rating_autore" do
    assert_difference("RatingAutore.count") do
      post rating_autori_url, params: { rating_autore: {  } }
    end
  ...
  test "should destroy rating_autore" do
    ...
    assert_redirected_to rating_autori_url
  end
end
